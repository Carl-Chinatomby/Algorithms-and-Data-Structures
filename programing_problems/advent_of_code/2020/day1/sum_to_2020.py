...
def find_product_of_numbers_that_sum_2020(values):
    visited_dict = {}
    for value in values:
        visited_dict[value] = 1
        # 2 numbers
        # comp_value = 2020 - value
        # if visited_dict.get(comp_value):
        #     return value * comp_value

    # 3 numbers
    for idx, val1 in enumerate(values):
        for val2 in values[idx:]:
            comp_value = 2020 - (val1 + val2)
            if visited_dict.get(comp_value):
                return val1 * val2 * comp_value
...
if __name__ == "__main__":
    ...
    print(find_product_of_numbers_that_sum_2020(values))
