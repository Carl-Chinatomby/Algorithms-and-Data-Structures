...
travel by toboggan might be easy, it's certainly not safe: there's very minimal steering and the area is covered in trees. You'll need to see which angles will take you near the fewest trees.
...
def get_num_of_trees(matrix, right=3, down=1):
    num_of_trees = 0
    x = 0
...
if __name__ == "__main__":
    ...
    print(get_num_of_trees(matrix))

    print(
        get_num_of_trees(matrix, right=1, down=1) *
        get_num_of_trees(matrix, right=3, down=1) *
        get_num_of_trees(matrix, right=5, down=1) *
        get_num_of_trees(matrix, right=7, down=1) *
        get_num_of_trees(matrix, right=1, down=2)
    )
